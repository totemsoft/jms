...
public class ActivationController
{
    ...
    @RequestMapping(value="/activation.do", params = "!dispatch", method = RequestMethod.GET)
    public String main(ModelMap model) throws ServiceException
    {
        return "activation/main";
    }

    @RequestMapping(value="/activation.do", params = "dispatch=new", method = RequestMethod.GET)
    public String tab0(ModelMap model) throws ServiceException
    {
        return "activation/new";
    }

    @RequestMapping(value="/activation.do", params = "dispatch=reviewed", method = RequestMethod.GET)
    public String tab1(ModelMap model) throws ServiceException
    {
        return "activation/reviewed";
    }

    @RequestMapping(value="/activation.do", params = "dispatch=investigation", method = RequestMethod.GET)
    public String tab2(ModelMap model) throws ServiceException
    {
        return "activation/investigation";
    }
