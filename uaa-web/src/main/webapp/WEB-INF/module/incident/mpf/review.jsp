...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	xmlns:perm="/WEB-INF/tld/argus-perm.tld" version="2.0">

    <c:set var="tabIndex" value="2" />

    <fmt:message var="title" key="title.review" />
        ...
        <html:window id="dataHeader${tabIndex}" title="${title}">
            <form id="dataForm${tabIndex}" name="dataForm${tabIndex}">
                <table class="nonDataTable">
                    <tr>
                        <td class="jms-label"><fmt:message key="incidentMpf.injury.type"/></td>
                        <td>
                                ...
                                <tr>
                                    <td>
                                        <div id="filter0">
                                            ...
                                            <input id="filter0Input" class="filterInput" type="text" name="injuryTypeName" value="${injuryTypeName}" />${nbsp}
