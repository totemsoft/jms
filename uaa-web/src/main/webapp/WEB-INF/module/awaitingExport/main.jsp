...
<jsp:root
    ...
    <fmt:message var="title" key="awaitingExport.title" />
    <input id="title" type="hidden" value="${title}" />

    <div id="tabViewDiv" class="yui-navset">
        <ul class="yui-nav">
            <li><a href="#tab0"><em><fmt:message key="awaitingExport.tab0"/></em></a></li>
        </ul>
    ...
    <script type="text/javascript" src="scripts/module/awaitingExport/main.js" />
