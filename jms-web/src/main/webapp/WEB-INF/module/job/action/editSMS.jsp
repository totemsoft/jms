                ...
                <td colspan="3">
                    <table class="nonDataTable" style="border: 1px solid #65A1D7;">
                        ...
                        <c:if test="${not empty contact.mobile}">
                            <tr>
                                <td><html:radio property="jobAction.destination" value="${contact.mobile}" onchange="YUD.get('action.contactId').value=${contact.id};"></html:radio></td>
