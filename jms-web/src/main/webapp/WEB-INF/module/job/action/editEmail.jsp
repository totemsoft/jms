...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <html:form action="/editEmail">
        ...
        <table class="nonDataTable">
            ...
            <html:errors property="jobAction.destination" />
            <tr>
                    ...
                    <table class="nonDataTable" style="border: 1px solid #65A1D7;">
                        <tr>
                            <td>
                                ...
                                <html:radio property="jobAction.destination" value="${fileActionForm.manualDestination}" onchange="YUD.get('action.contactId').value='';" />
                            </td>
                            <td><html:text property="manualDestination" styleClass="text" /></td>
                            <td colspan="2"></td>
                        </tr>
                        <c:forEach items="${contacts}" var="contact">
                        <c:if test="${not empty contact.email}">
                            <tr>
                                <td><html:radio property="jobAction.destination" value="${contact.email}" onchange="YUD.get('action.contactId').value=${contact.id};"></html:radio></td>
                                <td>${contact.email}</td>
            ...
            <html:errors property="jobAction.subject" />
            <tr>
