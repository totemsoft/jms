...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <html:form action="/rejectJobRequest" method="post">
        <html:hidden property="dispatch" value="reject" />
        ...
        <table class="nonDataTable">
            ...
            <jsp:include page="/WEB-INF/module/job/request/viewFileFca.jsp" />
            <tr>
            ...
            <html:errors property="entity.rejectReason" />
            <tr>
                <td class="jms-label"><bean:message key="label.jobRequest.rejectReason" bundle="${bundle}" /></td>
                <td colspan="3"><html:textarea property="entity.rejectReason" styleClass="textarea" /></td>
            </tr>
        </table>
    </html:form>
