...
"actions": {
"findAction": "setup/findWorkGroup.do?dispatch=find",
"viewAction": "setup/viewWorkGroup.do?dispatch=view",
"newAction":  "setup/editWorkGroup.do?dispatch=edit",
"editAction": "setup/editWorkGroup.do?dispatch=edit"}
}
</jsp:root>