...
"actions": {
"findAction": "setup/findAseType.do?dispatch=find",
"viewAction": "setup/viewAseType.do?dispatch=view",
"newAction":  "setup/editAseType.do?dispatch=edit",
"editAction": "setup/editAseType.do?dispatch=edit"}
}
</jsp:root>