...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <html:form action="/editAseType">
        <html:hidden property="dispatch" value="save" />
        <html:hidden property="entity.aseTypeId" />
        ...
        <table class="nonDataTable">
            ...
            <tr>
                <td class="jms-label"><bean:message key="label.aseType.name" bundle="${bundle}" /></td>
                <td><html:text property="entity.name" styleClass="text" /></td>
            </tr>
            <tr>
                <td class="jms-label"><bean:message key="label.aseType.active" bundle="${bundle}" /></td>
                <td>
