...
"actions": {
"findAction": "setup/findSiteType.do?dispatch=find",
"viewAction": "setup/viewSiteType.do?dispatch=view",
"newAction":  "setup/editSiteType.do?dispatch=edit",
"editAction": "setup/editSiteType.do?dispatch=edit"}
}
</jsp:root>