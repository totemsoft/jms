...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <html:form action="/editAseConnType">
        <html:hidden property="dispatch" value="save" />
        <html:hidden property="entity.aseConnTypeId" />
        ...
        <table class="nonDataTable">
            ...
            <tr>
                <td class="jms-label"><bean:message key="label.aseConnType.name" bundle="${bundle}" /></td>
                <td><html:text property="entity.name" styleClass="text" /></td>
            </tr>
            <tr>
                <td class="jms-label"><bean:message key="label.aseConnType.active" bundle="${bundle}" /></td>
                <td>
