...
"actions": {
"findAction": "setup/mailType.do?dispatch=find",
"viewAction": "setup/mailType.do?dispatch=view",
"newAction":  "setup/mailType.do?dispatch=edit",
"editAction": "setup/mailType.do?dispatch=edit"}
}
</jsp:root>