...
"actions": {
"findAction": "setup/findStakeholderType.do?dispatch=find",
"viewAction": "setup/viewStakeholderType.do?dispatch=view",
"newAction":  "setup/editStakeholderType.do?dispatch=edit",
"editAction": "setup/editStakeholderType.do?dispatch=edit"}
}
</jsp:root>