...
"actions": {
"findAction": "setup/findUserType.do?dispatch=find",
"viewAction": "setup/viewUserType.do?dispatch=view",
"newAction":  "setup/editUserType.do?dispatch=edit",
"editAction": "setup/editUserType.do?dispatch=edit"}
}
</jsp:root>