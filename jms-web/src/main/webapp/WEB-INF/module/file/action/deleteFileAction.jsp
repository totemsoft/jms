...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <html:form action="/deleteFileAction">
        <html:hidden property="dispatch" value="deleteFileAction" />
        ...
        <table class="nonDataTable">
            ...
            <tr>
                ...
                <td>
                    <fmt:formatDate var="dueDate" value="${fileActionForm.entity.dueDate}" pattern="${datePattern}" />
                    <html:text property="entity.dueDate" value="${dueDate}" readonly="true" styleClass="text" />
                </td>
                <td colspan="2" />
            </tr>
            <c:if test="${not empty fileActionForm.entity.destination}">
                <tr>
            ...
            <c:if test="${not empty fileActionForm.entity.subject}">
                <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:textarea property="entity.notation" readonly="true" styleClass="text" />
                </td>
            </tr>
        </table>
    </html:form>
