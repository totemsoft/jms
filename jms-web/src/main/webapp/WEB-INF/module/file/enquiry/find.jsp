...
"fields": [
"id", "sapCustNo", "fileId", "fcaId", "createdBy", "responsibleUser", "completedBy", "firstName", "surname", "notation", "complete", "delete"
],
...
"actions": {
"findAction": "file/enquiry.do?dispatch=find",
"newAction":  "file/addFileAction.do?dispatch=changeActionType&amp;actionTypeId=6&amp;todoAction=true",
"exportAction": "file/enquiry.do?dispatch=export"
}
}
</jsp:root>