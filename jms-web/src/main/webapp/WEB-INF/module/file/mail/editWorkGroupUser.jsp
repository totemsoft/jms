...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <tr>
        ...
        <td colspan="3">
            <html:select property="workGroup.workGroupId">
    ...
    <tr>
        ...
        <td colspan="3">
            <html:hidden property="user.userId" styleId="userId.edit.value" />
            <html:text property="user.contact.name" styleId="userId.edit" styleClass="text" />
