                    ...
                    <c:choose>
                            ...
                            <c:choose>
                                <c:when test="${not empty action.attachment.id}">
                                    <a title="Download File Document"
                                        href="javascript:YAHOO.jms.downloadFileActionAttachment(${action.id});">
                                        <span class="download">${nbsp}</span>
                                    </a>
                                </c:when>
                                <c:when test="${not empty action.document.id}">
                                    <a title="Download File Document"
                                        href="javascript:YAHOO.jms.downloadFileAction(${action.id});">
                                        <span class="download">${nbsp}</span>
                                    </a>
                                </c:when>
                            </c:choose>
                        ...
                        <c:otherwise>
                            <a title="Delete File Action"
                                href="javascript:YAHOO.jms.deleteFileAction(${action.id});">
                    ...
                    <c:choose>
                        <c:when test="${action.completed}">
                            <a title="View File Action"
                                href="javascript:YAHOO.jms.viewFileAction(${action.id});">
                                <span class="view">${nbsp}</span>
                            </a>
                        </c:when>
                        <c:otherwise>
                            <a title="Complete File Action"
                                href="javascript:YAHOO.jms.editFileAction(${action.id});">
