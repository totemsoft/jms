...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <c:set var="buildingContacts" value="${fileForm.entity.ownerBuildingContacts}" scope="request" />
    ...
    <c:if test="${fn:length(buildingContacts) gt 0}">
        <table class="nonDataTable">
            ...
            <tr>
                <td>
                    <jsp:include page="/WEB-INF/module/file/emergencyContact/viewByType.jsp" />
                </td>
            </tr>
        </table>
    </c:if>

    <c:set var="buildingContacts" value="${fileForm.entity.fireBuildingContacts}" scope="request" />
    ...
    <c:set var="buildingContacts" value="${fileForm.entity.securityBuildingContacts}" scope="request" />
