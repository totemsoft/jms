...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <table class="nonDataTable">
        ...
        <tr>
            ...
            <td><input type="text" readonly="readonly" value="${entity.invoiceBatch.invoiceType.name}" class="noborder" /></td>
            <td class="jms-label"><bean:message key="label.finance.invoice.invoiceArea" bundle="${bundle}" /></td>
            <td><input type="text" readonly="readonly" value="${entity.invoiceBatch.invoiceArea.name}" class="noborder" /></td>
        </tr>
    </table>
                ...
                <table class="noborder">
                    <tr>
                        <td class="jms-label">
                            ...
                            <c:if test="${entity.sapCustCreate}"><input type="checkbox" checked="checked" disabled="disabled" /></c:if>
                            <c:if test="${not entity.sapCustCreate}"><input type="checkbox" disabled="disabled" /></c:if>
                        </td>
                        <td class="jms-label">
                            <bean:message key="label.finance.invoice.sapCustChange" bundle="${bundle}" />${nbsp}
                            <c:if test="${entity.sapCustChange}"><input type="checkbox" checked="checked" disabled="disabled" /></c:if>
                            <c:if test="${not entity.sapCustChange}"><input type="checkbox" disabled="disabled" /></c:if>
                        </td>
                        <td class="jms-label">
                            <bean:message key="label.finance.invoice.sapCustUnblock" bundle="${bundle}" />${nbsp}
                            <c:if test="${entity.sapCustUnblock}"><input type="checkbox" checked="checked" disabled="disabled" /></c:if>
                            <c:if test="${not entity.sapCustUnblock}"><input type="checkbox" disabled="disabled" /></c:if>
                        </td>
                    </tr>
                </table>
            </td>
