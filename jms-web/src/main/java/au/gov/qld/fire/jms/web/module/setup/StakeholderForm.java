 ...
 */
public class StakeholderForm extends AbstractValidatorForm<StakeHolder>
{

    /** serialVersionUID */
    private static final long serialVersionUID = -1881398822762344656L;
     ...
     */
    @Override
    public void setEntity(StakeHolder entity)
    {
        super.setEntity(entity);
        //optional
        if (entity.getStakeHolderType() == null)
        {
            entity.setStakeHolderType(new StakeHolderType());
        }
