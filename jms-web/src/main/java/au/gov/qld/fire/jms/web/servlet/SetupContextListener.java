...
import au.gov.qld.fire.converters.EnumConverter;
...
public class SetupContextListener extends ContextLoaderListener implements ServletContextListener
{
    ...
    public void contextInitialized(final ServletContextEvent event)
    {
        try {
            ...
            LOG.info("super.contextInitialized");
        } catch (Throwable t) {
            t.printStackTrace();
            //return;
        }
        ...
        try
        {
            ...
            ConvertUtils.register(new BigDecimalConverter(java.math.BigDecimal.ZERO), java.math.BigDecimal.class);
            //
            //ConvertUtils.register(new EnumConverter<FileTypeEnum>(), FileTypeEnum.class);
            ConvertUtils.register(new EnumConverter<AseKeyStatusEnum>(), AseKeyStatusEnum.class);
            ConvertUtils.register(new EnumConverter<PaymentMethodEnum>(), PaymentMethodEnum.class);
            ConvertUtils.register(new EnumConverter<SentMethodEnum>(), SentMethodEnum.class);
