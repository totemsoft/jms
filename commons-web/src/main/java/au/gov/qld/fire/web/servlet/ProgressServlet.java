...
public class ProgressServlet extends HttpServlet
{
    ...
    public class MyPdf implements Runnable
    {
         ...
         * @throws ProgressException when the document isn't ready yet
         */
        public ByteArrayOutputStream getPdf() throws /*Progress*/Exception
        {
            if (percentage < 100)
            {
                throw new /*Progress*/Exception("The document isn't finished yet!");
            }
            return baos;
        }
    ...
    private void isFinished(ServletOutputStream stream) throws IOException
    {
        ...
        stream
            .print("The document is finished:<form method=\"POST\"><input type=\"Submit\" value=\"Get PDF\"></form>\n\t</body>\n</html>");
    }
